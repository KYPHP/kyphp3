-- MySQL dump 10.11
--
-- Host: localhost    Database: kyfrm_utf8
-- ------------------------------------------------------
...
CREATE TABLE `ky_form` (
  ...
  `f_date` varchar(30) character set utf8 NOT NULL,
  `pid` int(11) default '0',
  `ischeck` int(2) NOT NULL default '0',
  `sortid` int(10) default '0',
  `upfile` varchar(200) character set utf8 default NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE `ky_sort` (
  ...
  `sortname` varchar(50) character set utf8 NOT NULL,
...
INSERT INTO `ky_sort` VALUES (1,'心情',0),(2,'原创',0),(3,'子菜单1',1),(4,'子菜单2心情',1);
...
-- Dump completed on 2013-11-03 16:40:04
