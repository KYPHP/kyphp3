...
{	
	...
	$dirs[]=KYPHP_PATH.'/kyphp_extras';
	$dirs[]=KYPHP_PATH.'/custom_object';	
	$dirs[]=KYPHP_PATH.'/kyphp_safe';	
...
function php_exe($string,$obj,$data){
	$string=preg_replace_callback('/<\?php(.*?)\?>/is',function($s)use($obj,$data){php_exe_back($s[1],$obj,$data);},$string);
